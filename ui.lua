...
Open.Image = 'rbxassetid://120304335380449'
Open.ImageTransparency = 0.000
...
local Win = Library.new("我的脚本", "dark")
local Tab = Win:Tab("首页", "4370341699")
local Section = Tab:section("功能设置", true)

Section:Toggle("无敌模式", "godMode", false, function(state)
    print("无敌模式:", state)
end)

Section:Slider("移动速度", "speed", 5, 1, 10, false, function(value)
    print("速度:", value)
end)

Section:Button("执行操作", function()
    print("按钮被点击！")
    print("无敌模式状态:", Library.flags.godMode)
    print("速度值:", Library.flags.speed)
end)

Section:Label("提示：按 LeftControl 键显示/隐藏")
