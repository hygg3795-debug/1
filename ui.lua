...
local function createGeneralTab(Window, WindUI)
    ...
    local suggestSection = tab:Section({Title = "建议开"})
    ...
    local independentSection = tab:Section({Title = "独立功能"})
...
local function createPlayerTab(Window, WindUI)
    ...
    local tab = Window:Tab({Title = "玩家", Icon = "users"})
    ...
    local playerSection = tab:Section({Title = "玩家选项", Box = true})
...
local function createSuperTab(Window, WindUI)
    ...
    section:Button({Title = "火车头", Callback = function()
        pcall(function()
...
local function createActionTab(Window, WindUI)
    ...
    local section = tab:Section({Title = "动作列表", Box = true})
    ...
    section:Button({Title = "悬浮躺", Callback = function() clik() playAnimation(77840765435893, 1, 0) end})
    section:Button({Title = "JOJO姿势", Callback = function() clik() playAnimation(120629563851640, 1, 0) end})
    section:Button({Title = "直升机", Callback = function() clik() playAnimation(95301257497525, 1, 0) end})
    section:Button({Title = "俄罗斯舞蹈", Callback = function() clik() playAnimation(97148848007002, 1, 0) end})
    section:Button({Title = "俯卧撑", Callback = function() clik() playAnimation(108313130500811, 1, 0) end})
    section:Button({Title = "停止当前动作", Desc = "打断并停止所有正在播放的动作", Callback = function() stopAnimation() end})
...
local function createBlackholeTab(Window, WindUI)
    ...
    local tab = Window:Tab({Title = "黑洞", Icon = "circle"})
    ...
    local sectionH1 = tab:Section({Title = "h1", Box = true})
    ...
    local sectionH2 = tab:Section({Title = "h2", Box = true})
...
local function createLightingTab(Window, WindUI)
    ...
    section:Toggle({Title = "真实光影", Value = false, Callback = function(val)
        if val then
            saveLighting()
            clearEffects()
    ...
    section:Toggle({Title = "明亮光影", Value = false, Callback = function(val)
        if val then
            saveLighting()
            clearEffects()
    ...
    section:Toggle({Title = "画质增强Pro Max", Value = false, Callback = function(val)
        if val then
            saveLighting()
            clearEffects()
    ...
    section:Toggle({Title = "固定黄昏光影", Value = false, Callback = function(val)
        if val then
            saveLighting()
            clearEffects()
            for _, child in ipairs(Lighting:GetChildren()) do
